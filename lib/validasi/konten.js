...
import { kelompokValid, kelompokTemplate } from '../kelompokPengurus.js';
...
export function validasiPengurus(body) {
  ...
  return {
    nama, jabatan, tingkat, kelompok, wilayahId, foto: jalurGambar(body.foto, 'foto'), deskripsi: teksPanjang(body.deskripsi, 2000) || null,
