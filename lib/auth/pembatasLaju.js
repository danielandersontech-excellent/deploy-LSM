...
/** Untuk uji: setel ulang seluruh hitungan. */
export function setelUlangPembatas() {
  perIp.clear();
  perAkun.clear();
}

export const KONFIG_PEMBATAS = Object.freeze({ JENDELA_MS, GAGAL_IP_MAKS, GAGAL_AKUN_MAKS });
