...
const KONFIG = Object.freeze({
  ...
  // Tahap 9 B4: unggahan staf per AKUN (kunci `u:<id>`), bukan per IP — 60 gambar/jam cukup untuk redaksi, menahan skrip.
  unggah_staf: { maks: 60, jendelaMs: 60 * 60 * 1000 },
});
 ...
 * @param {'pengaduan'|'lacak'|'unggah_staf'} namespace
 */
