...
const menuStaf = [
  ...
  },
  {
    label: 'Galeri',
    href: '/staf/galeri',
    ikon: 'image', // KEPUTUSAN BARU Tahap 7: 'photo_library' tidak ada di 77 ikon Ikon.js (ikon tidak tergambar)
    peran: ['superadmin', 'redaktur', 'pimpinan_wilayah'],
  },
  {
    label: 'Pengguna',
    href: '/staf/pengguna',
    ikon: 'account_circle', // KEPUTUSAN BARU Tahap 7: 'group' tidak ada di Ikon.js
    peran: ['superadmin'],
  },
  {
    label: 'Pengaturan',
